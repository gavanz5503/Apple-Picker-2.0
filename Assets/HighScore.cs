...
using UnityEngine;
using TMPro; // We need this line for TMPro to work

public class HighScore : MonoBehaviour
{
    static private TextMeshProUGUI _TMPRO_TEXT;
    ...
    void Awake()
    {
        _TMPRO_TEXT = GetComponent<TextMeshProUGUI>();
    ...
    static public int SCORE
    {
        ...
        private set
        {
            ...
            if (_TMPRO_TEXT != null)
            {
                _TMPRO_TEXT.text = "High Score: " + value.ToString("#,0");
            }
        }
    }
